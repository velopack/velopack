...
define_locale_keys! {
    ...
    SETUP_WINDOWS_VERSION_UNSUPPORTED = "setup-windows-version-unsupported",
    SETUP_EMBEDDED_ZIP_MISSING = "setup-embedded-zip-missing",
    SETUP_OS_VERSION_REQUIRED = "setup-os-version-required",
    SETUP_CPU_ARCH_UNSUPPORTED = "setup-cpu-arch-unsupported",
    SETUP_STOP_APP_FAILED = "setup-stop-app-failed",
    SETUP_REMOVE_DIR_FAILED = "setup-remove-dir-failed",
    SETUP_UPDATE_EXE_MISSING = "setup-update-exe-missing",
    SETUP_MAIN_EXE_MISSING = "setup-main-exe-missing",
